...
const Body = ({ user, messages }) => {
  return (
    <div className="chatbody lg:chatheight xl:chatheight-xl 2xl:chatheight-2xl overflow-y-auto rounded-t-xl h-4/5 bg-purple-600 text-left ml-2 mr-5">
      <ScrollableFeed>
        <div>
          <div className="chatmessage flex flex-row w-3/5 mr-auto py-2">
            <div className="inline-block ml-2 bg-purple-900 rounded-lg shadow-xl lg:py-1 px-4 xl:py-3 px-4">
              <div className="lg:text-xs xl:text-sm 2xl:text-lg">
                <strong>Aditya Pimpalkar</strong>
              </div>
              <span className="lg:text-xs xl:text-sm 2xl:text-lg">
                Hi, Just wanted to know if you are indeed okay
              </span>
          ...
          <div className="chatmessage flex flex-row-reverse w-3/5 ml-auto py-2 ">
            <div className="inline-block mr-2  bg-yellow-500 rounded-lg shadow-xl lg:py-1 px-4 xl:py-3 px-4">
              <div className="lg:text-sm xl:text-lg 2xl:text-xl">
                <strong>Aditya Pimpalkar</strong>
              </div>
              <span className="lg:text-xs xl:text-sm 2xl:text-lg">
                Yeah, we were gonna plan our next trip together!
              </span>
              <div className="flex flex-row-reverse">
                <span className="text-xxs xl:text-xs 2xl:text-sm">
                  12:24 PM
    ...
    //             }
    //           >
    //             <span className="lg:text-sm xl:text-lg 2xl:text-xl">
    //               <strong>
