            ...
            return (
              ...
              >
                <div className="flex flex-col justify-center items-center lg:w-20">
                  <img
                    src={user.image}
                    className="rounded-full border-2 xl:mx-2 lg:h-11 lg:w-11 xl:h-12 xl:w-12 2xl:h-16 2xl:w-16"
                    alt="user"
                  />
                </div>
                <div className="flex flex-col border-b border-purple-400 lg:w-80">
                  <div className="flex flex-row w-full">
