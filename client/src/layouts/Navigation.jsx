        ...
        <div className="grid grid-cols-3 w-full bg-purple-900 shadow-xl">
          ...
          <div className="flex flex-row justify-center items-center">
            <div className="grid grid-cols-3 w-full">
              <button className="border-b-2 rounded-full border-yellow-500 lg:text-sm xl:text-base 2xl:text-xl 2xl:border-b-3">
                Chats
              </button>
              <button className="border-b-2 border-purple-900 lg:text-sm xl:text-base 2xl:text-lg">
                Groups
              </button>
              <button className="border-b-2 border-purple-900 lg:text-sm xl:text-base 2xl:text-lg">
                Friends
