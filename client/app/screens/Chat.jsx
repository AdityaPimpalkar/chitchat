      ...
      <div className="text-white">
        <main class="h-screen">
          ...
          <div className="flex flex-row">
            <div class="pt-20 w-1/5 h-full flex max-h-screen overflow-y-auto flex-col flex-grow bg-purple-50">
              ...
              embarrassing hidden in the middle of t
            </div>
            <div class=" w-4/5 bg-gray-50 max-h-screen overflow-y-auto">
              What is Lorem Ipsum? Lorem Ipsum is simply dummy text of the
              printing and typesetting industry. Lorem Ipsum has been the
              industry's standard dummy text ever since the 1500s, when an
              unknown printer took a galley of type and scrambled it to make a
              ...
              or non-characteristic words etc. What is Lorem Ipsum? Lorem Ipsum
